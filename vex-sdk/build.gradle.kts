...
tasks.javadoc {
    title = "VEX SDK"
    options {
        // Allow missing doc comments - most of the library is autogenerated
        // and the source dataset current doesn't contain any SDK documentation info.
        // There is no particular reason for this, it just hasn't been done yet.
        with(this as CoreJavadocOptions) {
            addBooleanOption("Xdoclint:html,syntax,accessibility,reference", true)
        }
    }
}
