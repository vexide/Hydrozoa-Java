...
public record V5MotorGearset(byte value) {
    ...
    public static V5MotorGearset GearSet_36 = new V5MotorGearset(kMotorGearSet_36);
    public static V5MotorGearset GearSet_18 = new V5MotorGearset(kMotorGearSet_18);
    public static V5MotorGearset GearSet_06 = new V5MotorGearset(kMotorGearSet_06);
}
